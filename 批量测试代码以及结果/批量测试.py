...
# # 指定Excel文件的保存路径
# excel_file_path = r"C:\Users\abc\Desktop\批量测试0923.xlsx"
#
# # 初始化一个空的DataFrame，用于存储数据
# df = pd.DataFrame(columns=['文件序号', '主诉', '其他', '既往病史', '现病史','音频文本'])
#
# # 计数器，用于记录文件的顺序编号
# file_counter = 1
#
...
#
# # 指定要上传文件的目录
# directory = r"C:\Users\abc\Desktop\录音材料"
# # 服务器上传地址
# upload_url = 'http://116.57.89.150:12345/upload'
# # 指定Excel文件的保存路径
...
#
#                 # 过滤需要的键并将数据编码转换为utf-8
#                 decoded_data = {key: value.encode('utf-8').decode('utf-8') for key, value in response_data.items() if key in df.columns[:-1]}  # 排除响应时间列
#
#                 # 添加文件序号和响应时间
#                 decoded_data['文件序号'] = filename
